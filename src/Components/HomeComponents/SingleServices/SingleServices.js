...
const SingleServices = ({service}) => {
    ...
    return (
        <Col md={4} className="p-2">
            ...
            :
            <img  className="img-fluid mb-3" src={`https://warm-crag-97524.herokuapp.com/${service.img}`} alt=""/>
        }
                ...
                <div className="d-flex justify-content-between">
                    ...
                    <Button variant='danger' onClick={()=>handleOrder()} className="btn-brand">Purchase Now</Button>
                </div>
            </Card>
        </Col>
    );
